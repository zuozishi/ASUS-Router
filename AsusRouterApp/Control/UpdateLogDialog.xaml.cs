...
{
    public sealed partial class UpdateLogDialog : ContentDialog
    {
        ...
        public class ClientDialogBrush
        {
            ...
            public ClientDialogBrush()
            {
                ...
                {
                    //整个页面采用FDS
                    mainGrid = Utils.UI.GetAcrylicBrush(AcrylicBackgroundSource.HostBackdrop, Edi.UWP.Helpers.UI.GetAccentColor(), Edi.UWP.Helpers.UI.GetAccentColor(), 0.8);
